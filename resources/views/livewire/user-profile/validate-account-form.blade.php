            ...
            <div class="row mt-5">
                ...
                <div class="col">
                    ...
                    <div class="card mb-5 mt-3"  style="border-radius: 15px;">
                        ...
                        <form wire:submit="submit_id">
                            @csrf
                            <div class="col-md-6 mx-5">
                                <div class="col-md" style="height: 40%; width: 40%">
                                    @if($valid_id)
                                        <img id="valid_id_img" src="{{$valid_id->temporaryUrl()}}" class="rounded-circle mt-5" alt="img">
                                    @else
                                        <img id="valid_id_img" src="{{asset('storage/photos/id').'/'.auth()->user()->valid_id_path}}"  class="rounded-circle mt-5" alt="img" >
