                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div id="password_section">
                            ...
                            <div class="col-md-6 mx-5 mt-5">
                                ...
                                <input type="text" class="form-control " id="password" name="password" wire:model.defer="password">
                            ...
                            <div class="col-md-6 mx-5 mt-2">
                                ...
                                <input type="text" class="form-control" id="newPassword" name="newPassword" wire:model.defer="newPassword">
                            ...
                            <div class="col-md-6 mx-5 mt-2 mb-5">
                                ...
                                <input type="text" class="form-control" id="email" name="confirmPassword" wire:model.defer="confirmPassword">
