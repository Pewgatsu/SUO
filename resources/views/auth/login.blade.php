    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
            ...
            <div class="col-md-10 mx-auto col-lg-5">
                ...
                <form id="loginForm" action="{{route('login')}}" class="needs-validation p-4 p-md-5 border rounded-3 bg-light"
                      method="POST" >
                    @csrf

                    <div class="form-floating flex-fill mb-4 ">
                        <input type="text" id="usernameField" name="username" class="form-control @error('username') is-invalid @enderror" placeholder="#"  autofocus>
                    ...
                    <div class="form-floating flex-fill mb-4 ">
                        <input type="text" id="passwordField" name="password" class="form-control @error('password') is-invalid @enderror"placeholder="#" autofocus>
