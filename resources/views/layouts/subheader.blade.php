            ...
            @auth
                ...
                @if(auth()->user()->account_type === 'Seller')
                    ...
                    <li class="nav-item dropdown" role="presentation">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                   href="{{ route('seller.components.motherboards') }}">Motherboard</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('seller.components.cpus') }}">CPU</a></li>
                            <li><a class="dropdown-item" href="{{ route('seller.components.cpu_coolers') }}">CPU
                                    Cooler</a></li>
                            <li><a class="dropdown-item" href="{{ route('seller.components.graphics_cards') }}">Graphics
                                    Card</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('seller.components.rams') }}">RAM</a></li>
                            <li><a class="dropdown-item" href="{{ route('seller.components.storages') }}">Storage</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('seller.components.psus') }}">PSU</a></li>
                            <li><a class="dropdown-item" href="{{ route('seller.components.computer_cases') }}">Computer
                                    Case</a>
                            </li>
                        </ul>
                    </li>
