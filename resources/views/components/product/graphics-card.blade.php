            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-floating mb-3">
                        <select class="form-select @error('graphics_card_component') is-invalid @enderror" id="graphics_card_component"
                            ...
                            @foreach($graphicsCardComponents as $graphics_card_component)
                                <option value="{{ $graphics_card_component->id }}"
                                        @if(old('graphics_card_component') !== null && old('graphics_card_component') == $graphics_card_component->id) selected @endif>{{ $graphics_card_component->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control @error('graphics_card_quantity') is-invalid @enderror"
                               ...
                               max="1000" placeholder="Quantity" value="{{ old('graphics_card_quantity') }}">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control @error('graphics_card_price') is-invalid @enderror"
                               ...
                               placeholder="Price" value="{{ old('graphics_card_price') }}">
                    ...
                    <div class="form-floating mb-3">
                        <textarea style="height: 250px"
                                  ...
                                  placeholder="Product Description">{{ old('graphics_card_description') }}</textarea>
